...
ANATOMICAL_LIMITS = {
    ...
    'LEFT_KNEE_ANGLE': (45, 180),
    'RIGHT_KNEE_ANGLE': (45, 180),
    
    'LEFT_WRIST_ANGLE': (90, 180),
    'RIGHT_WRIST_ANGLE': (90, 180),
    'LEFT_ANKLE_ANGLE': (70, 180),
    'RIGHT_ANKLE_ANGLE': (70, 180),

    'LEFT_SHOULDER_LOCAL_PITCH': (-180, 50),
    'RIGHT_SHOULDER_LOCAL_PITCH': (-180, 50),
    'LEFT_SHOULDER_LOCAL_ROLL': (0, 180),
    'RIGHT_SHOULDER_LOCAL_ROLL': (0, 180),

    'LEFT_HIP_LOCAL_PITCH': (-30, 130),
    'RIGHT_HIP_LOCAL_PITCH': (-30, 130),
    'LEFT_HIP_LOCAL_ROLL': (-45, 90),
    'RIGHT_HIP_LOCAL_ROLL': (-45, 90),

    'NECK_LOCAL_PITCH': (-60, 60),
    'NECK_LOCAL_ROLL': (-45, 45),
    'NECK_LOCAL_YAW': (-80, 80)
}
